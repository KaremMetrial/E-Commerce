...
@if( App::getLocale() == 'ar' )
        ...
        <!-- END Page Level CSS-->
        <!-- BEGIN Custom CSS-->
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/assets/css-rtl/style.css') }}">
        <!-- END Custom CSS-->
    @else
        <!-- BEGIN VENDOR CSS-->
        ...
        <!-- BEGIN Page Level CSS-->
        <link rel="stylesheet" type="text/css"
              href="{{ asset('assets/admin/css/pages/login-register.css') }}">
        <!-- END Page Level CSS-->
    @endif
</head>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-mobile">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                            ...
                            <i class="flag-icon flag-icon-{{ $flagMap[$currentLocale] ?? 'us' }}"></i>
...
<footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; {{ date('Y') }}  <a class="text-bold-800 grey darken-2"
                                                                                     ...
                                                                                     target="_blank">METRIAL </a>, All rights reserved. </span>
...
<script src="{{ asset('assets/admin/vendors/js/forms/icheck/icheck.min.js') }}"
        type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN MODERN JS-->
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{ asset('assets/admin/js/scripts/forms/form-login-register.js') }}"
        type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
<!-- BEGIN CAPTCHA JS-->
