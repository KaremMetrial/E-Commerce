                        ...
                        <div class="col-md-4 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{ route('dashboard.login') }}" novalidate method="POST">
                                            @csrf
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="email" class="form-control input-lg" id="email"
                                                       ...
                                                       tabindex="1" required
                                                       data-validation-required-message="{{ __('auth.validation.email_required') }}"
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="password" class="form-control input-lg" id="password"
                                                       ...
                                                       tabindex="2" required
                                                       data-validation-required-message="{{ __('auth.validation.password_required') }}"
                                                       name="password">
                                                <div class="form-control-position">
                                                    <i class="la la-key"></i>
                                                </div>
                                ...
                                <div class="card-footer border-0">
                                    ...
                                    <a href="#" class="btn btn-info btn-block btn-lg mt-3">
                                        <i class="ft-user"></i> {{ __('auth.register') }}
                                    </a>
                                </div>
                            </div>
                        </div>
